            ...
            with st.container():
                ...
                with filter_col1:
                    ...
                    if st.button("Apply Date Filter"):
                        if filter_date:
                            st.session_state.filter_date = filter_date.strftime('%Y-%m-%d')
                        else:
                ...
                with filter_col2:
                    ...
                    if st.button("Search Remarks"):
                        if remarks_search.strip():
                            st.session_state.remarks_search = remarks_search.strip().lower()
                        else:
