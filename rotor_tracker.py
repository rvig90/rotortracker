...
def get_gsheet_connection():
    try:
        return get_rotor_log_spreadsheet().sheet1
    except Exception as e:
...
def load_from_gsheet():
    try:
        ...
        st.session_state.last_sync = "Load failed"
...
def get_gsheet_connection():
    return get_rotor_log_spreadsheet()
